...
class SelectMedical extends StatefulWidget {
  @override
  _SelectMedicalState createState() => _SelectMedicalState();
}

class _SelectMedicalState extends State<SelectMedical> {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              title("Pincode", height),
              TextFormField(
                controller: _NGOName,
                decoration: decoration("Eg. 201013", height, Icons.pin_drop),
                keyboardType: TextInputType.emailAddress,
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    return 'Please enter your name';
              ...
              SizedBox(height: height * 0.02),
              title("Country", height),
              dropdown1(["India"], "Select Country", width, height, _phoneNumberController,
                  (p0, p1) => null, Icons.ac_unit_rounded),
              SizedBox(height: height * 0.02),
              SizedBox(
                height: height * 0.06,
              ),
